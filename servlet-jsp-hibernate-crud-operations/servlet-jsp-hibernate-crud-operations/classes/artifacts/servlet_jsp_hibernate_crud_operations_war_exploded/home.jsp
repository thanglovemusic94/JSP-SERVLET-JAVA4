...
<body>
	...
	<form action="${registerUrl}" method="post" enctype="multipart/form-data">
		<table>
			...
			<tr>
				<td>Image:</td>
				<td><input type="file" name="photo" value="images/${customer.image}"></td>
			</tr>
			<tr>
				<td>First Name:</td>
			...
			<tr>
				<td>Mobile:</td>
				<td><input type="tel" pattern="[0][0-9]{9}" name="mobile" value="${customer.mobile}" required></td>
			</tr>
	...
	<table>
		...
		<c:forEach items="${customerList}" var="customer">
			<tr>
				<td>${customer.id}</td>
				<td><img src="<c:url value="images/${customer.image}"></c:url> " width="150px" height="auto"></td>
